...
function money(month, content, elem, percent) {
	content = content.replace(/\s*/g, '');
	var value = ((parseInt(content) * percent) * parseInt(month)) + parseInt(content);
...
$(document).ready(function () {
	...
	showGoogleMaps();
		...
		setInterval(function () {
			money($("#contentMonth1").val(), $("#contentSlider1").val(), $('.money1'), 0.16)
			money($("#contentMonth").val(), $("#contentSlider").val(), $('.money'), 0.21)
		}, 100)
